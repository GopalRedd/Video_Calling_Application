package com.gopal.indotestvideo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean isNetworkAvailable() {
        ...
        NetworkInfo activieinfo = connectivityManager.getActiveNetworkInfo();
        return activieinfo!=null && activieinfo.isConnected();
    }
    /// AgoraEngine Initialization
